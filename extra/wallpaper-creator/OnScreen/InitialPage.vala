...
namespace WallpaperCreator.OnScreen {
    ...
    public class InitialPage : Box {
        ...
        Entry locationEntry = new Entry() { placeholder_text = "/Users/christianloopp/my_picture.jpg" };
        ...
        public InitialPage() {
            ...
            aboutLabel.set_markup("<span font='Lato Light 15px' color='white'>by @christianloopp</span>");
            ...
            typeComboBox.changed.connect(() => {
                ...
                if(wallpaperType == "image") {
                    ...
                    locationEntry.placeholder_text = "/Users/christianloopp/my_picture.jpg";
                    locationEntry.set_sensitive(false);
                    ...
                    locationEntry.placeholder_text = "/Users/christianloopp/my_video.mp4";
                    locationEntry.set_sensitive(false);
